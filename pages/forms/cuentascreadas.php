...
//Busqueda datos cuentas

mysql_select_db($database_crm, $crm);
$query_cuentas = sprintf("SELECT * FROM Cuentas ");
$cuentas= mysql_query($query_cuentas, $crm) or die(mysql_error());
  ...
  <aside class="main-sidebar"> 
    ...
    <section class="sidebar"> 
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview"> <a href="../../inicio.php"> <i class="fa fa-dashboard"></i> <span>Página Principal</span> </a> </li>
        <li class="treeview active"> <a href="#"> <i class="fa fa-edit"></i> <span>Cuentas</span> <span class="pull-right-container"> <i class="fa fa-angle-left pull-right"></i> </span> </a>
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="cuentascreadas.php"><i class="fa fa-circle-o"></i> Cuentas Creadas</a></li>
          </ul>
        </li>
  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Cuentas Creadas</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12 "> 
          ...
          <div class="box ">
            <div class="box-header">
              <h3 class="box-title">Listado de cuentas creadas</h3>
            </div>
            <!-- /.box-header -->
            
            <div class="box-body">
              <?php
						 if($totalRows_cuentas > 0){
						 echo"<table id='example1' class='table table-bordered table-striped'>";
						    ...
						    do{
									  ...
									  echo "<tr>";
									  echo "<td>".$row_cuentas['idCuentas']."</td>";
									  echo "<td>".$row_cuentas['nombreEmpresa']."</td>";
								      echo "<td>".$row_cuentas['telefonoCuenta']."</td>";
									  echo "<td> <a href=perfilcuenta.php?cuenta=".$row_cuentas['idCuentas']."><button type='submit' class='btn btn-primary'/>Ver Cuenta</button></a></td>";		
									  echo "</tr>";
							 ...
							 <tfoot>
								...
								echo" <button type='button' class='btn btn-block btn-primary btn-lg ion-plus-circled'> No hay cuentas creadas. </button>";  
						 }
							?>
