...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "llamada")) {// Al momento de oprimir el boton continuar verifica el nombre del formulario y ejecuta los comandos sql
  $insertSQL = sprintf("INSERT INTO  Llamada(Oportunidad_idOportunidad, Asesores_idAsesor, Contacto_idContacto,actividad,fechaActualizacion) VALUES (%s,%s,%s,%s,%s)",
                       GetSQLValueString($_POST['Oportunidad_idOportunidad'], "text"),// Ingresa el numero de identificaci�n de la oportunidad con el cual el usuario esta llenando la encuesta                     
                       GetSQLValueString($_POST['Asesores_idAsesor'], "text"),
					   GetSQLValueString($_POST['Contacto_idContacto'], "text"),
					   GetSQLValueString($_POST['actividadllamada'], "text"),
  ...
  $insertGoTo = "perfiloportunidadllamada.php";// envía a la siguiente página despues de oprimir el botón continuar
  if (isset($_SERVER['QUERY_STRING'])) {
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
             <li ><a href="perfiloportunidad.php? oportunidad=<?php echo $row_oportunidad['idOportunidad']?>">Historial Oportunidad</a></li>
              ...
              <li class="active"><a href="#">Crear Llamada</a></li>
              ...
              <div class=" active tab-pane" id="activity2">
                <div class="box">
                  <div class="box-header">
                    <h3 class="box-title">Crear LLamada</h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                    <form role="form" action="<?php $editFormAction?>" method="post" name="llamada">
                      
                      <!-- text input -->
                      <div class="form-group">
                       <button class="bg-blue-active" disabled>Llamada N° <?php echo $next_id?> </button>
                      </div>
                      <!-- text input -->
                      <div class="form-group">
                      <label>Datos del asesor</label> 
                        ...
                        <input type="text" class="form-control"  name="Asesores_idAsesor" readonly value="<?php echo $row_usuario['idAsesor']?>" >
                         <input type="text" class="form-control"  name="nombreasesor" readonly value="<?php echo $row_usuario['nombreAsesor']?>">
                      </div>
                   
                      <div class="form-group">
                        <label>Datos del contacto</label>
                                              
                        <input type="text" class="form-control"  name="Contacto_idContacto" readonly value="<?php echo $row_contacto['idContacto']?>" >
                         <input type="text" class="form-control"  name="nombreContacto" readonly value="<?php echo $row_contacto['nombreContacto']?>">
                        <input type="text" class="form-control"  name="telefonoContacto" readonly value="<?php echo $row_contacto['telefonoContacto']?>-<?php echo $row_cuenta['telefonoCuenta']?>"> 
                      ...
                      <div class="form-group">
                        ...
                        <textarea id="editor1" name="actividadllamada" rows="10" cols="80" style="min-width:100%; max-width:100%" placeholder="Especifique que se realizo en la llamada"></textarea>
                         <span class="textareaRequiredMsg">Debe especificar lo hecho en la llamada</span></span>
                         
                      </div>
                      
                      <div class="box-footer">
                        <button type="reset" class="btn btn-default" onClick="document.getElementById('llamada').reset()>Borrar">Borrar</button>
                         <input type="hidden" name="MM_insert" value="llamada" />
