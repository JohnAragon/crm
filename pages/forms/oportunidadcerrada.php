...
//Busqueda datos cuentas,oportunidad y asesor
        ...
        <div class="col-md-9">
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              ...
              <li><a href="perfilhistorialtarea1.php?oportunidad=<?php echo $row_oportunidad['idOportunidad']?>">Reporte tareas</a></li>
            </ul>
                  ...
                  <!-- timeline item: Por cada fila de la consulta hecha en el historial se creara una de estas etiquetas segun el tipo de actividad realizada-->
                     ...
                     <?php	
					    ...
					    do{ 
						  ...
						  echo"<div class='timeline-body'>";
						  echo "El día: <b>".$row_historial['fechaVisita']."</b> a las <b>".$row_historial['horaVisita']."</b> <br> En la dirección: ".$row_historial['direccionEvento']."";
						  echo"</div>";
						  echo"</li>";
					   }
					    else if(($row_historial['TipoActividad']=="Estado") && ($row_historial['estadoOportunidad']=='Positiva')){ 
								  echo" <li>";
								  echo "<i class='fa fa-envelope bg-green ion-checkmark-circled'></i>";
								  echo"<div class='timeline-item'>";
								  echo "<span class='time'><i class='fa fa-clock-o'></i><b>".$row_historial['fechaActualizacion']."</b></span>";
								  echo"<h3 class='timeline-header'><a href='#'>".$row_historial['nombreAsesor']." </a> ha cambiado el estado de la propuesta :</h3>";
								  echo"<div class='timeline-body'>";
								  echo "El estado de la oportunidad ha cambiado a: <b>".$row_historial['estadoOportunidad']."</b>. Se ha documentado con el siguiente concepto:<br>".$row_historial['detalle_Estado'].". </br> Por consiguiente se procede a gestionar la entrega del servicio y facturación";
								  echo"</div>";
								  echo"</li>";
							}
							
						  else if(($row_historial['TipoActividad']=="Estado") && ($row_historial['estadoOportunidad']=='Negativa')){ 
								  echo" <li>";
								  echo "<i class='fa fa-envelope bg-red ion-close-circled'></i>";
								  echo"<div class='timeline-item'>";
								  echo "<span class='time'><i class='fa fa-clock-o'></i><b>".$row_historial['fechaActualizacion']."</b></span>";
								  echo"<h3 class='timeline-header'><a href='#'>".$row_historial['nombreAsesor']." </a> ha cambiado el estado de la propuesta :</h3>";
								  echo"<div class='timeline-body'>";
								  echo "El estado de la oportunidad ha cambiado a: <b>".$row_historial['estadoOportunidad']."</b>. Esta oportunidad se ha documentado con el siguiente concepto:<br>".$row_historial['detalle_Estado'].".<br> Por consiguiente su gestión ha acabado y queda deshabilitado su seguimiento.";
								  echo"</div>";
								  echo"</li>";
						 }
